...
```{r difference transformations,message=FALSE,warning=FALSE}
...
*This is where the percentile data comes in. I want to split the parameter ranges into zones of high or low failure probability. Percentiles are suitable for aggregation and are separated by a fixed distance, which renders this task a lot easier.*

*The below code is a mess and I have done my best to explain it. I wouldn't be surprised at all if there is a much less complicated way to do the same thing, but I am a little wary of tinkering at this point.*

```{r sf_table,message=FALSE,warning=FALSE}
...
*The resulting table has 128 entries, 106 of which belong to our six variables in question. For the most part they have a failure rate of 0 or 1 (or close). Altogether, they cover a significant part of the possible range of values for their respective variables.*
